    ...
    for j in range(0, stock_vecs.shape[0], batch_size):
        ...
        for i in range(0, gen_vecs.shape[0], batch_size):
            ...
            if agg == 'max':
                ...
                agg_tanimoto[i:i + y_gen.shape[1]] = agg_tanimoto[i:i + y_gen.shape[1]] + jac.sum(0)
                total[i:i + y_gen.shape[1]] = total[i:i + y_gen.shape[1]] + jac.shape[0]
    if agg == 'mean':
        agg_tanimoto = agg_tanimoto / total
    if p != 1:
